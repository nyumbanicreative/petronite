...
Class PurchaseModel extends CI_Model {
    ...
    var $cols_select_purchase_order = ['d.user_fullname po_driver_name','d.user_driving_license po_driver_license','ri.ri_status', 'po.po_id', 'po.po_date', 'po.po_volume', 'po.po_number', 'ftg.fuel_type_group_name', 'po.po_truck_number', 'po.po_status', 'st.station_name'];
    ...
    public function savePurchaseOrder($data, $admin_id) {
        ...
        $this->db->where('po_id', $po_id)->update('purchase_order', ['po_number' => 'LPO_' . cus_preciding_zeros($po_number)]);
