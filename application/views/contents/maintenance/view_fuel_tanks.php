            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body no-padding">
                        <table id="tanks_table" class="table  table-hover table-striped table-light" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Tank Name</th>
                                    <th>Fuel Type</th>
                            ...
                            <tbody>
                                <?php
                                foreach ($fuel_tanks as $i => $ft) {
                                    ?>
                                    <tr>
                                        <td><?php echo strtoupper($ft['fuel_tank_name']); ?></td>
                                        <td><?php echo $ft['fuel_type_name'].' - '.$ft['fuel_type_generic_name'] ; ?></td>
                                        <td><?php echo $ft['fuel_tank_capacity'] ?></td>
                                        <td><?php echo $ft['fuel_tank_opening_balance'] ?></td>
