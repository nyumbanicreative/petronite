    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo site_url('business/submitbusinessdetails/'.$business['business_id']); ?>" method="post" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 input-field">
                                <input type="text" name="busi_name" value="<?php echo !empty(set_value('submit'))? set_value('busi_name') : $business['business_name']; ?>" autocomplete="off" id="hall_name" placeholder="Enter the business name" class="form-control <?php echo!empty(form_error('busi_name')) ? 'is-invalid' : ''; ?>">
                                <?php echo form_error('busi_name'); ?>
                            </div>
                        </div>
                        <div class="line"></div>
                        <div class="form-group row">
                            <label class="col-sm-3 form-control-label"> Business Description</label>
                            <div class="col-sm-9 input-field">
                                <textarea rows="5" name="busi_descr"  id="hall_description" placeholder="Enter the the business description" class="form-control <?php echo!empty(form_error('busi_descr')) ? 'is-invalid' : ''; ?>"><?php echo !empty(set_value('submit'))? set_value('busi_descr') : $business['business_description']; ?></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 input-field">
                                <select id="select_busi_cat"  name="busi_cat" style="width:100%" class="">
                                    <option   value=""></option>
                                    <?php
                                    $busi_cat = !empty(set_value('submit'))? set_value('busi_cat') : $business['business_cat_id'];
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 input-field">
                                <input type="text" name="busi_phone_number" value="<?php echo !empty(set_value('submit'))? set_value('busi_phone_number') : $business['business_phone']; ?>" id="hall_size" placeholder="Enter the business phone number" class="form-control <?php echo!empty(form_error('busi_phone_number')) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 input-field">
                                <input type="text" name="busi_email" value="<?php echo !empty(set_value('submit'))? set_value('busi_email') : $business['business_email']; ?>" id="hall_size" placeholder="Enter the business email address" class="form-control <?php echo!empty(form_error('busi_email')) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 input-field">
                                <input type="text" name="busi_owner_name" value="<?php echo !empty(set_value('submit'))? set_value('busi_owner_name') : $business['business_owner_name']; ?>"  placeholder="Enter the business owner  name" class="form-control <?php echo!empty(form_error('busi_owner_name')) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 input-field">
                                <input type="text" name="busi_owner_phone_number" value="<?php echo !empty(set_value('submit'))? set_value('busi_owner_phone_number') : $business['business_owner_phone']; ?>" placeholder="Enter the business owner phone number" class="form-control <?php echo!empty(form_error('busi_owner_phone_number')) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 form-control-label"> Business Email Address</label>
                            <div class="col-sm-9 input-field">
                                <input type="text" name="busi_owner_email" value="<?php echo !empty(set_value('submit'))? set_value('busi_owner_email') : $business['business_owner_email']; ?>"  placeholder="Enter the business owner email address" class="form-control <?php echo!empty(form_error('busi_owner_email')) ? 'is-invalid' : ''; ?>">
                ...
                <!--
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 input-field">
                                <input type="text" name="busi_nb_url" value="<?php echo !empty(set_value('submit'))? set_value('busi_nb_url') : $business['business_nb_url']; ?>" id="hall_size" placeholder="Enter the N-Biashara Suggested URL" class="form-control <?php echo!empty(form_error('nb_url')) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 input-field">
                                <input type="text" name="facebook_url" value="<?php echo !empty(set_value('submit'))? set_value('facebook_url') : $business['business_fb_url']; ?>" id="hall_size" placeholder="Enter the facebook profile URL" class="form-control <?php echo!empty(form_error('facebook_url')) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 input-field">
                                <input type="text" name="instagram_url" value="<?php echo !empty(set_value('submit'))? set_value('instagram_url') : $business['business_ig_url']; ?>" id="hall_size" placeholder="Enter the instagram profile URL" class="form-control <?php echo!empty(form_error('instagram_url')) ? 'is-invalid' : ''; ?>">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9 input-field">
                                <input type="text" name="twitter_url" value="<?php echo !empty(set_value('submit'))? set_value('twitter_url') : $business['business_tw_url']; ?>" id="hall_size" placeholder="Enter the twitter profile URL" class="form-control <?php echo!empty(form_error('twitter_url')) ? 'is-invalid' : ''; ?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#somecomponent').locationpicker({
            ...
            scrollwheel: false,
            location: {
                latitude: <?php echo !empty(set_value('submit'))? set_value('busi_lat') : $business['business_gps_lat']; ?>,
                longitude:<?php echo !empty(set_value('submit'))? set_value('busi_lng') : $business['business_gps_lng']; ?>
            },
            zoom: 13,
            radius: 10,
