    ...
    <div class="container-fluid" style="min-height: 500px;">
        ...
        <div id="filter" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
            <div role="document" class="modal-dialog">
                <form action="<?php echo site_url('reports/expensereport'); ?>" method="post" class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group" id="item_name">
                                    ...
                                    <select style="width: 100%" id="_payment_method" name="expense_type">
                                        <option value="0">All Types</option>
                                        <?php
                                        foreach ($expense_types as $et) {
                                            ?>
                                            <option <?php echo set_value('expense_type') == $et['het_id'] ? 'selected' : ''; ?> value="<?php echo $et['het_id']; ?>"><?php echo $et['het_name']; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col col-sm-6 col-md-6 col-12 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <p>
                                            <?php
                                            echo $selected_expense_type_name;
                                            ?>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <tbody>
                                ...
                                foreach ($hall_expenses as $i => $exp) {
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo hall_nice_timestamp($exp['he_timestamp']); ?></td>
                                        <td><?php echo $exp['het_name']; ?></td>
                                        <td><?php echo hall_price_form_french($exp['he_amount']); ?> Tsh</td>
                                        <td><?php echo $exp['user_fullname']; ?></td>
