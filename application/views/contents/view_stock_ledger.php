            ...
            <div role="document" class="modal-dialog">
                <form id="add_hall_item_form" class="modal-content">
                    <div class="modal-header">
                        <h4 id="exampleModalLabel" class="modal-title">Introduce New Item</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group" id="add_item_id">
                                    ...
                                    <select style="width: 100%" id="_add_item_id" name="add_item_id">
                                        <option value=""></option>
                                        <?php 
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group" id="stock_note">
                                    <label>Stock Notice <em><sup>(Optional)</sup></em></label>
                                    <textarea placeholder="Enter stock notice" rows="4" class="form-control" name="stock_notice"  value=""></textarea>
                                </div>
                            </div>
                        ...
                        <table id="items_table" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Item Name</th>
                                    <th style="width:40px">Qty Before</th>
                                    <th style="width:40px">Stock</th>
                                    <th>Stock Type</th>
                                    <th style="width:40px">Qty After</th>
                                    <th>Stock Notes</th>
                                    <th style="width:100px">User</th>
<!--                                    <th style=4width: 80px">UOM</th>-->
                                    <!--<th style=" width:10px;"></th>-->
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                foreach ($stock_ledger as $i => $s) {
                                   
                                    ?>
                                    <tr>
                                        <th scope="row"><?php echo $s['item_stock_added_on']; ?></th>
                                        <td><?php echo $s['item_name']; ?></td>
                                        <td><?php echo $s['item_stock_qty_before']; ?></td>
                                        <td><?php echo $s['item_stock_qty']; ?></td>
                                        <td><?php echo $s['item_stock_type']; ?></td>
                                        <td><?php echo $s['item_stock_qty_after']; ?></td>
                                        <td><?php echo $s['item_stock_notice']; ?></td>
