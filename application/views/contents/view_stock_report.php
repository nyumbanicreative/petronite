                        ...
                        <table id="items_table" class="table table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>Item Name</th>
                                    <th style="width:120px">Stock In Qty</th>
                                    <th style="width:120px">Stock Out Qty</th>
                                    <th style="width:100px">Available Qty</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                foreach ($stock_report as $i => $r) {
                                   
                                    ?>
                                    <tr>
                                        <th scope="row"><?php echo $i + 1; ?></th>
                                        <td><?php echo $r['item_name']; ?></td>
                                        <td><?php echo $r['stock_in']; ?></td>
                                        <td><?php echo $r['stock_out']; ?></td>
                                        <td><?php echo $r['item_available_qty']; ?></td>
