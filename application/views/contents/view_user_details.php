...
<div class="breadcrumb-holder container-fluid">
    <ul class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo site_url('user/userslist'); ?>">Users List</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col col-sm-6 col-md-6 col-12 col-lg-4">
                                    <div class="form-group">
                                        <label>Amount</label>
                                        <div>
                                            <p style="font-size: 20px;" class="badge <?php echo ($user['user_balance'] <= 0 ) ? 'badge-danger' : 'badge-success'; ?>"><?php echo hall_price_form_french($user['user_balance']) . ' ' . CURRENCY; ?></p>
                                        </div>
                            ...
                            <table id="services_table" class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:200px" class="text-right">Commission Amount</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    ...
                                    foreach ($commissions as $i => $c) {
                                        $total_commission_amount += $c['cm_amount'];
                                        ?>
                                        <tr>
                                           <!--<th scope="row"><?php echo $i + 1; ?></th>-->
                                            <td><?php echo hall_nice_timestamp($c['cm_timestamp']); ?></td>
                                            <td><?php echo $c['business_name']; ?></td>
                                            <td><?php echo $c['subs_start_date'] . ' To ' . $c['subs_end_date']; ?></td>
                                            <td> <?php echo hall_price_form_french($c['subs_amount']).' '.CURRENCY; ?></td>
                                            <td class="text-right">
                                                <?php echo hall_price_form_french($c['cm_amount']); ?> Tsh
                                            </td>
                                        </tr>
                                        <?php
                                    }
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-right">
                                            <?php echo hall_price_form_french($total_commission_amount).' '.CURRENCY; ?>
                                        </th>
                                    </tr>
